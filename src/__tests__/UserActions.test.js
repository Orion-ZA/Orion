...
describe('UserActions', () => {
  ...
  describe('Favourites Button', () => {
    ...
    it('should have active class when favourited', () => {
      ...
      const { container } = renderWithRouter(<UserActions {...defaultProps} userSaved={userWithFavourite} />);
  ...
  describe('Wishlist Button', () => {
    ...
    it('should have active class when in wishlist', () => {
      ...
      const { container } = renderWithRouter(<UserActions {...defaultProps} userSaved={userWithWishlist} />);
  ...
  describe('Completed Button', () => {
    ...
    it('should have active class when completed', () => {
      ...
      const { container } = renderWithRouter(<UserActions {...defaultProps} userSaved={userWithCompleted} />);
  ...
  describe('Multiple Actions State', () => {
    it('should handle trail in multiple lists', () => {
      ...
      const { container } = renderWithRouter(<UserActions {...defaultProps} userSaved={userWithMultipleActions} />);
