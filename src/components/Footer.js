      ...
      <div className='footer-grid'>
        <div className='brand-col'>
          ...
          <p className='brand-tag'>
            Crowd-sourced hiking intelligence. Find, plan, and share your next adventure.
          </p>
          <div className='socials' aria-label='Social media'>
            <button type='button' aria-label='X (Twitter)' className='social'>
              <svg width='24' height='24' viewBox='0 0 24 24' fill='none' aria-hidden='true'>
                <path
                  d='M17.53 3H21.5l-7.19 8.21L23 21h-7.5l-5.36-6.61L3.67 21H-.3l7.64-8.73L1 3h7.61l4.77 5.89L17.53 3zm-1.13 15.5h2.09l-5.67-7.01-1.5-1.85L5.59 5H3.5l5.67 7.01 1.5 1.85 5.73 7.14z'
                  fill='currentColor'
                />
              </svg>
            </button>
            <button type='button' aria-label='Instagram' className='social'>
              <svg width='24' height='24' viewBox='0 0 24 24' fill='none' aria-hidden='true'>
                <rect width='24' height='24' rx='6' fill='currentColor' opacity='.1' />
                <rect
                  x='3'
                  y='3'
                  width='18'
            ...
            <button type='button' aria-label='YouTube' className='social'>
              <svg width='24' height='24' viewBox='0 0 24 24' fill='none' aria-hidden='true'>
                <rect width='24' height='24' rx='6' fill='currentColor' opacity='.1' />
                <path d='M9.75 8.5v7l6.5-3.5-6.5-3.5z' fill='currentColor' />
                <rect
                  x='2.5'
                  y='6.5'
                  width='19'
        ...
        <div className='links-col'>
          ...
          <Link to='/trails' state={{ openSubmission: true }}>
            Submit a Trail
          </Link>
        ...
        <div className='subscribe-col'>
          ...
          <p className='subscribe-copy'>
            Subscribe for trail updates, maps, and hidden gems. No spam.
          </p>
