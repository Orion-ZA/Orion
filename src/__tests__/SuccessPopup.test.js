...
describe('SuccessPopup Component', () => {
  ...
  describe('Edge Cases', () => {
    ...
    test('handles very long message', () => {
      const longMessage =
        'This is a very long success message that contains a lot of text and should be displayed properly in the popup without breaking the layout or causing any issues with the component rendering.';
