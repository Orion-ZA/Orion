...
const TestComponent = () => {
  ...
  return (
    <div>
      <button data-testid='show-info' onClick={() => show('Info message', { type: 'info' })}>
        Show Info
      </button>
      <button
      ...
      <button data-testid='show-error' onClick={() => show('Error message', { type: 'error' })}>
        Show Error
      </button>
      <button
      ...
      <button data-testid='show-default' onClick={() => show('Default message')}>
        Show Default
      </button>
      <button
