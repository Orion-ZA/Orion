                ...
                <div className='settings-form'>
                  <div className='preference-group'>
                    ...
                    <div className='preference-options'>
                      <label
                        className={`preference-option ${preferences.theme === 'light' ? 'selected' : ''}`}
                      >
                        <input
                          type='radio'
                          name='theme'
                      ...
                      <label
                        className={`preference-option ${preferences.theme === 'dark' ? 'selected' : ''}`}
                      >
                        <input
                          type='radio'
                          name='theme'
                      ...
                      <label
                        className={`preference-option ${preferences.theme === 'auto' ? 'selected' : ''}`}
                      >
                        <input
                          type='radio'
                          name='theme'
                        ...
                        <span className='option-label'>
                          Auto <small style={{ opacity: 0.65 }}>(System → {resolvedTheme})</small>
                        </span>
                      </label>
                      <div
                        style={{ marginTop: '0.75rem', fontSize: '0.8rem', color: 'var(--muted)' }}
                      >
                  ...
                  <div className='preference-group'>
                    ...
                    <label className='toggle-switch'>
                      <input
                        ...
                        onChange={e =>
                          handlePreferenceChange('showActivityStatus', e.target.checked)
                        }
                      />
                      <span className='toggle-slider'></span>
