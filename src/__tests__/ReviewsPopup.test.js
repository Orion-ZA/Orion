...
describe('ReviewsPopup Component', () => {
  ...
  describe('Edge Cases', () => {
      ...
      const longReview = [
        {
          id: 'review-1',
          message:
            'This is a very long review message that contains a lot of text and should be displayed properly in the popup without breaking the layout or causing any issues with the component rendering.',
          userName: 'John Doe',
          timestamp: '2024-01-15T10:30:00Z',
        },
      ];
    ...
    test('handles special characters in review content', () => {
      ...
      expect(
        screen.getByText(/Great trail! 🥾 Beautiful views! ⛰️ Highly recommend! ⭐/)
      ).toBeInTheDocument();
    });
  });
