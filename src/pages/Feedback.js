      ...
      <div className='feedback-container'>
            ...
            <div className='rating-container'>
              {[...Array(5)].map((_, index) => {
                ...
                return (
                  ...
                  >
                    <Star size={32} fill={value <= (hover || rating) ? 'currentColor' : 'none'} />
                  </button>
                );
              })}
            </div>
              ...
              placeholder={
                feedbackType === 'bug'
                  ...
                  : feedbackType === 'suggestion'
                    ...
                    : feedbackType === 'praise'
                      ? 'We love hearing what works well!'
        ...
        <div className='feedback-footer'>
          ...
          <div className='help-options'>
            ...
            <a href='mailto:support@orionapp.com' className='help-link'>
              Email Support
            </a>
          </div>
        </div>
