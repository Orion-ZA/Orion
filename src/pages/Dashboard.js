  ...
  return (
    <div className='container'>
      <section className='fade-in-up' style={{ display: 'grid', gap: '1rem' }}>
        <h1 className='gradient-text' style={{ margin: '0.5rem 0 0' }}>
          Welcome to Orion
        </h1>
        <p style={{ color: 'var(--muted)' }}>
          Plan, discover, and share hiking adventures. This dashboard gives you a snapshot of
          trails, contributions, and alerts across the community.
        </p>
      </section>
      ...
      <section className='grid cols-3 fade-in-up' style={{ marginTop: '1rem' }}>
        <div className='scale-in reveal' style={{ '--delay': '60ms' }}>
          <div
            ...
            style={{ padding: '1rem', display: 'grid', gap: '.5rem', justifyItems: 'start' }}
          >
            <h3>Browse Trails</h3>
            <p className='muted'>Search by location, difficulty, distance, and terrain.</p>
            <div>
              <Link to='/trails' className='button'>
                Open Trails
              </Link>
            </div>
          </div>
      ...
      <section
        className='card scale-in hero reveal'
        style={{
          marginTop: '1rem',
          padding: 0,
          overflow: 'hidden',
      ...
      >
        ...
        >
          <div>
            ...
            <p className='muted' style={{ maxWidth: '68ch', margin: '0 auto 1rem' }}>
              Discover crowdsourced insights on difficulty, terrain, distance, photos, and real-time
      ...
      <section className='grid cols-4 fade-in-up' style={{ marginTop: '1rem' }}>
        ...
        <div className='card glass scale-in reveal' style={{ padding: '1rem', '--delay': '120ms' }}>
          ...
          <Link to='/mytrails' className='button'>
            Open MyTrails
          </Link>
        </div>
