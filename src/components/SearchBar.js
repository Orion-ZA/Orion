            ...
            {searchSuggestions.map((suggestion, index) => {
              ...
              return (
                <button
                  ...
                  onClick={() =>
                    handleSuggestionClick(suggestionData.displayName || suggestionData.name)
                  }
                  ...
                  <div className='suggestion-icon-container'>
                    {suggestionData.type === 'trail' ? (
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        viewBox='0 0 24 24'
                        className='suggestion-icon trail-icon'
                        aria-hidden='true'
                      >
                        <path
                          fillRule='evenodd'
                      ...
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        viewBox='0 0 24 24'
                        className='suggestion-icon location-icon'
                        aria-hidden='true'
                      >
                        <path
                          fillRule='evenodd'
                  ...
                  <div className='suggestion-content'>
                    <div className='suggestion-header'>
                      <span className='suggestion-title'>
                        {suggestionData.displayName || suggestionData.name}
                      </span>
                    ...
                    {(suggestionData.description ||
                      ...
                      suggestionData.difficulty ||
                      suggestionData.distance ||
                      suggestionData.elevationGain) && (
