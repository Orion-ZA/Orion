...
describe('AchievementsPage', () => {
  ...
  it('handles API error with retry functionality', async () => {
    ...
    expect(
      screen.getByText('Unable to load achievements. Please check your connection and try again.')
    ).toBeInTheDocument();
  ...
  it('has correct CSS classes applied', async () => {
    ...
    const achievementsContent = screen
      .getByText('Achievement Badges')
      .closest('.achievements-content');
