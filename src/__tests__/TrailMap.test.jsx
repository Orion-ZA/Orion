...
jest.mock(
  ...
  () => {
    ...
    const Marker = ({ children, onClick, ...rest }) => (
      <div data-testid='mock-marker' onClick={onClick} {...rest}>
        {children}
      </div>
    );
...
describe('TrailMap', () => {
  ...
  it('renders trail markers and handles click toggle via onTrailClick', () => {
    ...
    const trails = [{ id: 't1', name: 'T1', longitude: 10, latitude: 20, difficulty: 'Easy' }];
  ...
  it('applies difficulty color and icon for trail marker', () => {
    const trails = [{ id: 't1', name: 'T1', longitude: 10, latitude: 20, difficulty: 'Hard' }];
  ...
  it('hover enter/leave on trail marker toggles hoveredTrail', () => {
    const props = defaultProps();
    const trails = [{ id: 't1', name: 'Trail A', longitude: 10, latitude: 20, difficulty: 'Easy' }];
