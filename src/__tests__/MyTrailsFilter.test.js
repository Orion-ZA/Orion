...
describe('MyTrailsFilter', () => {
  ...
  describe('Search Functionality', () => {
    ...
    it('calls onSearchChange with empty string when clear search is clicked', () => {
      const onSearchChange = jest.fn();
      render(
        <MyTrailsFilter {...defaultProps} searchQuery='test' onSearchChange={onSearchChange} />
      );
  ...
  describe('Difficulty Filter', () => {
    it('displays current difficulty selection', () => {
      render(
        <MyTrailsFilter
          {...defaultProps}
          filters={{ ...defaultProps.filters, difficulty: 'Moderate' }}
        />
      );
  ...
  describe('Distance Range Slider', () => {
    it('displays current distance range', () => {
      render(
        <MyTrailsFilter
          {...defaultProps}
          filters={{ ...defaultProps.filters, minDistance: 5, maxDistance: 15 }}
        />
      );
    ...
    it('prevents min distance from exceeding max distance', () => {
      ...
      render(
        <MyTrailsFilter
          {...defaultProps}
          filters={{ ...defaultProps.filters, maxDistance: 10 }}
    ...
    it('prevents max distance from going below min distance', () => {
      ...
      render(
        <MyTrailsFilter
          {...defaultProps}
          filters={{ ...defaultProps.filters, minDistance: 10 }}
          onFilterChange={onFilterChange}
        />
      );
  ...
  describe('Status Filter', () => {
    ...
    it('displays current status selection', () => {
      render(
        <MyTrailsFilter
          {...defaultProps}
          activeTab='submitted'
          filters={{ ...defaultProps.filters, status: 'open' }}
        />
      );
    ...
    it('calls onFilterChange when status is changed', () => {
      const onFilterChange = jest.fn();
      render(
        <MyTrailsFilter {...defaultProps} activeTab='submitted' onFilterChange={onFilterChange} />
      );
  ...
  describe('Clear Filters Functionality', () => {
    ...
    it('detects active filters correctly', () => {
      ...
      rerender(
        <MyTrailsFilter
          {...defaultProps}
          filters={{ ...defaultProps.filters, difficulty: 'Easy' }}
        />
      );
      expect(screen.getByText('Clear Filters')).toHaveClass('visible');
      ...
      rerender(
        <MyTrailsFilter {...defaultProps} filters={{ ...defaultProps.filters, minDistance: 5 }} />
      );
      expect(screen.getByText('Clear Filters')).toHaveClass('visible');

      // Test max distance filter
      rerender(
        <MyTrailsFilter {...defaultProps} filters={{ ...defaultProps.filters, maxDistance: 30 }} />
      );
      expect(screen.getByText('Clear Filters')).toHaveClass('visible');
  ...
  describe('Edge Cases', () => {
    ...
    it('handles extreme distance values', () => {
      render(
        <MyTrailsFilter
          {...defaultProps}
          filters={{ ...defaultProps.filters, minDistance: 0, maxDistance: 50 }}
        />
      );
