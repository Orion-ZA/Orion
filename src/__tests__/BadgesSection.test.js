...
describe('BadgesSection', () => {
  ...
  it('handles API error gracefully', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('No achievements yet. Start hiking to earn badges!')).toBeInTheDocument();
    });
  ...
  it('limits display to first 3 badges', async () => {
    const manyBadgesData = {
      badges: [
        { name: 'Badge 1', description: 'First badge', category: 'achievement', difficulty: 'standard' },
        { name: 'Badge 2', description: 'Second badge', category: 'achievement', difficulty: 'standard' },
        { name: 'Badge 3', description: 'Third badge', category: 'achievement', difficulty: 'standard' },
        { name: 'Badge 4', description: 'Fourth badge', category: 'achievement', difficulty: 'standard' },
        { name: 'Badge 5', description: 'Fifth badge', category: 'achievement', difficulty: 'standard' }
      ]
    };
