...
describe('RatingsChart', () => {
  ...
  it('handles empty feedback list', () => {
    ...
    const averageRating = screen
      .getByText('Average Rating')
      .closest('.ratings-chart-stat')
      .querySelector('.ratings-chart-stat-value');
    const totalRatings = screen
      .getByText('Total Ratings')
      .closest('.ratings-chart-stat')
      .querySelector('.ratings-chart-stat-value');
  ...
  it('handles single rating value correctly', () => {
    const singleRatingFeedbacks = [{ id: '1', rating: 5, message: 'Only 5 star rating' }];
