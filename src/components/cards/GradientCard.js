...
const StyledWrapper = styled.div`
  ...
  .icon-wrap { color: ${props => props.$accent === 'yellow' ? '#FFE34B' : 'var(--primary)'}; margin-bottom: 20px; }

  .bg-gradient-box { position: relative; }
  .bg-gradient-box::after {
    position: absolute; top: -1px; bottom: -1px; left: -1px; right: -1px; content: ""; z-index: -1; border-radius: 28px;
    background: ${props => props.$accent === 'yellow'
      ? 'linear-gradient(71deg, #110e0e, #afa220, #110e0e)'
      : 'linear-gradient(71deg, #0d1b1b, #5bc0be, #0d1b1b)'};
    filter: saturate(120%);
  }
