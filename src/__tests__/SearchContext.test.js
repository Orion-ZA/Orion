...
const TestComponent = () => {
  ...
  return (
    <div>
      ...
      <button data-testid='handle-search' onClick={() => context.handleSearch('test query')}>
        Search
      </button>
      <button data-testid='get-suggestions' onClick={() => context.getSuggestions('test')}>
        Get Suggestions
      </button>
      <button data-testid='get-suggestions-short' onClick={() => context.getSuggestions('t')}>
        Get Short Suggestions
      </button>
      <button data-testid='get-suggestions-empty' onClick={() => context.getSuggestions('')}>
      ...
      <button data-testid='update-trails-null' onClick={() => context.updateTrailsData(null)}>
        Update Trails Null
      </button>
      ...
      <button data-testid='set-search-query' onClick={() => context.setSearchQuery('manual query')}>
        Set Search Query
      </button>
      <button
      ...
      <button data-testid='set-show-suggestions' onClick={() => context.setShowSuggestions(true)}>
...
describe('SearchContext', () => {
  ...
  describe('Suggestions Handling', () => {
    ...
    it('handles null query gracefully', () => {
      ...
      const NullTestComponent = () => {
        ...
        return (
          <button data-testid='get-null-suggestions' onClick={() => getSuggestions(null)}>
    ...
    it('handles trails without names', async () => {
      const mockTrails = [{ description: 'Trail without name' }, { name: 'Valid Trail' }];
  ...
  describe('Data Management', () => {
    it('updates trails data', () => {
      const mockTrails = [{ name: 'Test Trail 1' }, { name: 'Test Trail 2' }];
  ...
  describe('Suggestion Deduplication', () => {
    it('removes duplicate suggestions based on displayName', async () => {
      const mockTrails = [{ name: 'Table Mountain Trail' }];
