...
jest.mock('lucide-react', () => ({
  Sun: ({ size, className, ...props }) => <div data-testid="sun" data-size={size} className={className} {...props} />,
  Cloud: ({ size, className, ...props }) => <div data-testid="cloud" data-size={size} className={className} {...props} />,
  CloudRain: ({ size, className, ...props }) => <div data-testid="cloud-rain" data-size={size} className={className} {...props} />,
  CloudSnow: ({ size, className, ...props }) => <div data-testid="cloud-snow" data-size={size} className={className} {...props} />,
...
describe('WeatherSection', () => {
  ...
  describe('No Weather Data State', () => {
    it('should show no weather message when weatherData is empty array', () => {
      ...
      expect(screen.getByText(/This could be due to API limits or location data issues./)).toBeInTheDocument();
    });
