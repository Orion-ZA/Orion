      ...
      questions: [
        {
          ...
          answer:
            "To save a trail to your wishlist, find the trail you're interested in either through search or browsing. Click on the heart icon ♥ next to the trail name. You can access your wishlist later from your profile page.",
        },
        {
        ...
        },
        {
          ...
          answer:
            'Trust us, bruh. Trail difficulty ratings are based on community feedback and our algorithm that considers elevation gain, terrain type, and distance. However, conditions can change with weather, so always exercise caution and check recent reviews before attempting a trail.',
        },
      ],
    },
    account: {
      ...
      questions: [
        {
          ...
          answer:
            'If you\'ve forgotten your password, you need psychiatric help. (free advice; always use Google) Anyway, click "Forgot Password" on the login page. Enter your email address, and we\'ll send you a link to reset your password. The link will expire after 24 hours for security reasons.',
        },
        {
          question: 'Can I change my username?',
          answer:
            "Yes, you can change your display name at any time from your profile settings. However, your unique user ID cannot be changed as it's used to maintain your hiking history and connections.",
        },
        {
          question: 'How do I delete my account?',
          answer:
            'You can\'t. As a matter of fact, if you do this, we will sell your data to big companies 🙂. Orion is free to use, remember? So the cost is your data. haha. I\'m not joking. Account deletion can be done in the privacy section of your settings. Please note that this action is permanent and will \"remove\" all your data, including saved trails, reviews, and hiking history.',
        },
      ],
    },
    technical: {
      ...
      questions: [
        {
          ...
          answer:
            'Get a new device, bruh! 😭 First, try closing and reopening the app. If the problem persists, check for updates in your app store as we regularly release bug fixes. If issues continue, contact our support team with details about your device and OS version.',
        },
        {
          question: 'How do I enable notifications?',
          answer:
            'Notifications can be enabled in your device settings for the Orion app and customized in the notification section of your profile. We send alerts for trail updates, messages, and recommended hikes based on your preferences.',
        },
        {
          question: 'Why is my location not showing accurately?',
          answer:
            "Location accuracy depends on your device's GPS signal and settings. Ensure location services are enabled for Orion and try moving to an area with better GPS reception. Using Wi-Fi can also help improve location accuracy.",
        },
      ],
    },
  };
          ...
          <div className='help-cards'>
            <div className='help-card'>
              ...
              <button className='card-link'>
                <Link to='//www.youtube.com/watch?v=Aq5WXmQQooo'> Explore guides </Link>
                <ArrowRight size={16} />
              </button>
            </div>
          ...
          <div className='faq-items'>
            {filteredCategories[activeCategory]?.questions.map((item, index) => (
              <div key={index} className='faq-item'>
                <button className='faq-question' onClick={() => toggleItem(activeCategory, index)}>
