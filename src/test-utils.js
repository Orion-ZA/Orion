...
export const mockTrails = [
  {
    ...
    gpsRoute: [
      ...
      { latitude: -26.177, longitude: 27.9695 },
      { latitude: -26.1785, longitude: 27.968 },
    ],
  ...
  },
  {
    ...
    rating: 4.6,
    gpsRoute: [
      { latitude: -26.294, longitude: 28.025 },
      { latitude: -26.2952, longitude: 28.0261 },
      { latitude: -26.2965, longitude: 28.0275 },
      { latitude: -26.2981, longitude: 28.029 },
    ],
    location: { latitude: -26.294, longitude: 28.025 },
  ...
  },
  {
    ...
    rating: 4.5,
    gpsRoute: [
      { latitude: -26.069, longitude: 28.14 },
      { latitude: -26.0695, longitude: 28.1412 },
      { latitude: -26.07, longitude: 28.1425 },
      { latitude: -26.0705, longitude: 28.1438 },
    ],
    location: { latitude: -26.069, longitude: 28.14 },
...
export const createMockTrail = (overrides = {}) => ({
  ...
  gpsRoute: [
    { latitude: -26.1755, longitude: 27.9715 },
    { latitude: -26.176, longitude: 27.972 },
  ],
  location: { latitude: -26.1755, longitude: 27.9715 },
  tags: ['test'],
  status: { status: 'open', lastUpdated: new Date() },
