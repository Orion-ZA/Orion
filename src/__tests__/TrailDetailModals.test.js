    ...
    return (
      <div data-testid="contribution-modal">
        ...
        <button 
          ...
          onClick={props.onCloseContributionModal}
        >
          Close Contribution
        </button>
        <button 
    ...
    return (
      <div data-testid="alert-modal">
        ...
        <button 
          ...
          onClick={() => props.onSubmit({ test: 'alert' })}
        >
          Add Alert
        </button>
      </div>
    ...
    return (
      <div data-testid="report-modal">
        ...
        <button 
          ...
          onClick={() => props.onSubmit({ test: 'report' })}
        >
          Submit Report
        </button>
      </div>
...
describe('TrailDetailModals', () => {
  ...
  describe('Alert Modal Props', () => {
    ...
    it('passes trail ID and name correctly', () => {
      render(<TrailDetailModals {...defaultProps} trailId="custom-trail" trailName="Custom Trail" />);
  ...
  describe('Component Integration', () => {
    it('renders all modals in correct order', () => {
      ...
      const modals = container.querySelectorAll('[data-testid="contribution-modal"], [data-testid="alert-modal"], [data-testid="report-modal"]');
