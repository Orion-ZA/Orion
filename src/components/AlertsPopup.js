                ...
                <div className='orion-alerts-popup-item-header'>
                  ...
                  {alert.isTimed && timeRemaining[alert.id || alert.type] && (
                    <span className='orion-alerts-popup-timer'>
                      <Timer size={10} />
                      {timeRemaining[alert.id || alert.type].hours}h{' '}
                      {timeRemaining[alert.id || alert.type].minutes}m{' '}
                      {timeRemaining[alert.id || alert.type].seconds}s
                    </span>
                  )}
                </div>
                <span className='orion-alerts-popup-message'>
                  {alert.message || alert.comment || 'No message'}
                </span>
              </div>
            ))
          )}
