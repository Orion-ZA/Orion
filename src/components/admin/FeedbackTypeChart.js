...
export default function FeedbackTypeChart() {
  ...
  const typeData = ['praise', 'bug', 'suggestion', 'general']
    .map(type => {
      ...
      <div className='feedback-type-chart-content'>
        <ResponsiveContainer width='100%' height={300}>
          ...
          >
            ...
            <Bar dataKey='count' radius={[6, 6, 0, 0]} label={renderCustomBarLabel}>
        ...
        {typeData.map((item, index) => (
          <div key={index} className='feedback-type-chart-breakdown-item'>
            <div className='feedback-type-chart-breakdown-header'>
              ...
              ></div>
              <span className='feedback-type-chart-breakdown-label'>
                {item.count} {item.label} Count
              </span>
            </div>
            <div className='feedback-type-chart-breakdown-percentage feedback-type-chart-breakdown-percentage-hover'>
