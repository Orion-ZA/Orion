...
describe('TrailInfo', () => {
  ...
  describe('Description Section', () => {
    it('should render description when provided', () => {
      ...
      expect(screen.getByText('A beautiful trail with stunning views of Cape Town.')).toBeInTheDocument();
    });
  ...
  describe('Performance', () => {
    it('should render efficiently with complex trail data', () => {
      const complexTrail = {
        ...
        route: Array.from({ length: 100 }, (_, i) => ({ lat: -33.9249 + i * 0.001, lng: 18.4241 + i * 0.001 }))
      };
