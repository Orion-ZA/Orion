...
const TrailsPanel = ({
  ...
  const sortedTrails = useMemo(() => {
    const validTrails = filteredTrails.filter(
      trail =>
        trail.longitude &&
        trail.latitude &&
    ...
    e => {
      if (isDragging && window.innerWidth <= 768) {
        ...
        const newHeight = Math.max(
          20,
          Math.min(90, initialHeight.current + (deltaY / window.innerHeight) * 100)
        );
                      ...
                      {currentUserId && (
                        <>
                          <button
                            ...
                            title={
                              userSaved.favourites.includes(trail.id)
                          ...
                          <button
                            ...
                            title={
                              userSaved.wishlist.includes(trail.id)
                          ...
                          <button
                            ...
                            title={
                              userSaved.completed.includes(trail.id)
                      ...
                      <div className='trail-item-distance'>
                        ...
                        {(() => {
                          const referenceLocation =
                            isSearchMode && searchLocation ? searchLocation : userLocation;
                          if (referenceLocation) {
                            return (
