...
describe('GradientCard', () => {
  it('renders with default props', () => {
    render(<GradientCard title='Test Title' description='Test Description' />);
  ...
  it('renders with yellow accent when specified', () => {
    render(<GradientCard title='Test Title' description='Test Description' accent='yellow' />);
  ...
  it('renders with custom icon when provided', () => {
    ...
    render(<GradientCard title='Test Title' description='Test Description' icon={customIcon} />);
  ...
  it('renders with long title and description', () => {
    ...
    const longDescription =
      'This is a very long description that contains multiple sentences and should display properly in the card layout without breaking the design.';

    render(<GradientCard title={longTitle} description={longDescription} />);
  ...
  it('renders with empty title and description', () => {
    render(<GradientCard title='' description='' />);
  ...
  it('renders with special characters in title and description', () => {
    ...
    render(<GradientCard title={specialTitle} description={specialDescription} />);
  ...
  it('renders with React element as icon', () => {
    ...
    render(<GradientCard title='Test Title' description='Test Description' icon={reactIcon} />);
  ...
  it('renders with null icon', () => {
    render(<GradientCard title='Test Title' description='Test Description' icon={null} />);
  ...
  it('renders with undefined icon', () => {
    render(<GradientCard title='Test Title' description='Test Description' icon={undefined} />);
  ...
  it('renders with invalid accent prop', () => {
    render(<GradientCard title='Test Title' description='Test Description' accent='invalid' />);
  ...
  it('handles null title and description', () => {
    render(<GradientCard title={null} description={null} />);
  ...
  it('handles very long strings without breaking layout', () => {
    ...
    render(<GradientCard title={veryLongTitle} description={veryLongDescription} />);
  ...
  it('has proper semantic structure for screen readers', () => {
    render(<GradientCard title='Accessible Title' description='Accessible Description' />);
  ...
  it('renders with string icon (should be treated as text)', () => {
    render(<GradientCard title='Test Title' description='Test Description' icon='String Icon' />);

    expect(screen.getByText('String Icon')).toBeInTheDocument();
  });

  it('renders with number icon (should be converted to string)', () => {
    render(<GradientCard title='Test Title' description='Test Description' icon={123} />);
  ...
  it('handles accent prop with different data types', () => {
    render(<GradientCard title='Test Title' description='Test Description' accent={123} />);
  ...
  it('handles accent prop with boolean values', () => {
    render(<GradientCard title='Test Title' description='Test Description' accent={true} />);
  ...
  it('updates correctly when props change', () => {
    const { rerender } = render(
      <GradientCard title='Original Title' description='Original Description' accent='teal' />
    );

    expect(screen.getByText('Original Title')).toBeInTheDocument();

    rerender(
      <GradientCard title='Updated Title' description='Updated Description' accent='yellow' />
    );
  ...
  it('handles unicode characters correctly', () => {
    ...
    render(<GradientCard title={unicodeTitle} description={unicodeDescription} />);
  ...
  it('handles RTL text correctly', () => {
    ...
    render(<GradientCard title={rtlTitle} description={rtlDescription} />);
