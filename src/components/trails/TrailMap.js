      ...
      {showSubmissionPanel && (
        <div className='submission-mode-popup'>
          <div className='popup-content'>
            ...
            <button onClick={onCloseSubmission} className='popup-close-btn'>
              <X size={12} />
            </button>
          </div>
        </div>
              ...
              >
                <div className='trail-mini-card' onClick={e => e.stopPropagation()}>
                  <div className='trail-mini-header'>
                    ...
                    <div
                      className='trail-mini-difficulty'
                      style={{ backgroundColor: getDifficultyColor(hoveredTrail.difficulty) }}
                    >
